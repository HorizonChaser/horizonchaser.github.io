...
- [Part 1 概述](#part-1-概述)
  - [Chapter 1 绪论](#chapter-1-绪论)
    ...
    - [协议和标准 \[IMP\]](#协议和标准-imp)
      - [协议三要素](#协议三要素)
      - [标准](#标准)
  - [Chapter 2 网络模型](#chapter-2-网络模型)
    - [OSI模型 [IMP]](#osi模型-imp)
      - [分层的概念与层间连接](#分层的概念与层间连接)
      - [各层功能](#各层功能)
        - [物理层](#物理层)
          - [功能](#功能)
        - [数据链路层](#数据链路层)
    ...
    - [地址与寻址 [IMP]](#地址与寻址-imp)
      ...
      - [端口地址](#端口地址)
      - [专用地址](#专用地址)
- [Part 2 物理层与介质](#part-2-物理层与介质)
  - [Chapter 3 数据与信号](#chapter-3-数据与信号)
    - [关于频率, 频域与带宽](#关于频率-频域与带宽)
    - [数字信号与传输](#数字信号与传输)
      - [比特率](#比特率)
      - [位长](#位长)
      - [传输](#传输)
      ...
      - [传输减损 \[IMP\]](#传输减损-imp)
        ...
        - [噪声](#噪声)
          - [信噪比](#信噪比)
    - [数据速率限制 \[IMP\]](#数据速率限制-imp)
      - [无噪声通道: 奈奎斯特比特率](#无噪声通道-奈奎斯特比特率)
      - [有噪声通道: 香农容量定理](#有噪声通道-香农容量定理)
      - [总结 \[IMP\]](#总结-imp)
    - [性能](#性能)
      - [带宽](#带宽)
      - [吞吐量](#吞吐量)
      - [延迟](#延迟)
        ...
        - [处理延迟](#处理延迟)
      - [带宽与延迟的乘积](#带宽与延迟的乘积)
  - [Chapter 4 数字传输](#chapter-4-数字传输)
    - [线路编码](#线路编码)
      - [数据元素与信号元素 \[IMP\]](#数据元素与信号元素-imp)
        - [数据速率与信号速率](#数据速率与信号速率)
      - [基线偏移](#基线偏移)
      - [自同步](#自同步)
    - [线路编码 \[IMP\]](#线路编码-imp)
      - [NRZ (不归零编码)](#nrz-不归零编码)
        - [NRZ-L 与 NRZ-I](#nrz-l-与-nrz-i)
      - [RZ (归零编码)](#rz-归零编码)
      - [曼彻斯特编码 和 差分曼彻斯特编码](#曼彻斯特编码-和-差分曼彻斯特编码)
        - [曼彻斯特编码](#曼彻斯特编码)
        - [差分曼彻斯特编码](#差分曼彻斯特编码)
      - [AMI 和 伪三元编码](#ami-和-伪三元编码)
      - [多电平与多线路编码](#多电平与多线路编码)
      - [线路编码 总结](#线路编码-总结)
    - [块编码](#块编码)
    - [扰码](#扰码)
    ...
    - [传输模式 \[IMP\]](#传输模式-imp)
      - [串行与并行](#串行与并行)
      - [同步与异步](#同步与异步)
  - [Chapter 5 模拟传输](#chapter-5-模拟传输)
    - [比特率和波特率 \[IMP\]](#比特率和波特率-imp)
    - [幅移键控 (ASK) \[IMP\]](#幅移键控-ask-imp)
    - [频移键控 (FSK) \[IMP\]](#频移键控-fsk-imp)
    - [相移键控 (PSK) \[IMP\]](#相移键控-psk-imp)
      - [二进制PSK (BPSK)](#二进制psk-bpsk)
      - [正交PSK (QPSK)](#正交psk-qpsk)
      - [星座图](#星座图)
    - [正交振幅调制 (QAM) \[IMP\]](#正交振幅调制-qam-imp)
    - [模拟信号调制](#模拟信号调制)
  - [Chapter 6 带宽利用](#chapter-6-带宽利用)
    - [FDM (频分复用) \[IMP\]](#fdm-频分复用-imp)
    - [TDM (时分复用) \[IMP\]](#tdm-时分复用-imp)
      - [同步 TDM](#同步-tdm)
        - [T-1 帧 \[IMP\]](#t-1-帧-imp)
        - [E 线路](#e-线路)
      - [统计 TDM](#统计-tdm)
    ...
    - [扩频](#扩频)
      - [跳频扩频 (FHSS)](#跳频扩频-fhss)
      - [直接序列扩频](#直接序列扩频)
  - [Chapter 7 传输介质](#chapter-7-传输介质)
    - [有向介质](#有向介质)
      - [双绞线 \[IMP\]](#双绞线-imp)
      - [同轴线缆](#同轴线缆)
      - [光纤](#光纤)
    - [无线通信](#无线通信)
  - [Chapter 8 交换](#chapter-8-交换)
    - [电路交换 \[IMP\]](#电路交换-imp)
    - [数据报交换 \[IMP\]](#数据报交换-imp)
    - [虚电路网络 \[IMP\]](#虚电路网络-imp)
      - [编址](#编址)
      ...
      - [延迟](#延迟-1)
    - [交换机结构](#交换机结构)
    - [Chapter 9 使用电话网和有线电视网进行数据传输](#chapter-9-使用电话网和有线电视网进行数据传输)
      - [信令的概念 \[IMP\]](#信令的概念-imp)
      - [调制与解调](#调制与解调)
      - [ADSL (非对称数字用户线路)](#adsl-非对称数字用户线路)
- [Part 3 数据链路层](#part-3-数据链路层)
  - [Chapter 10 检错与纠错](#chapter-10-检错与纠错)
    - [差错的类型](#差错的类型)
    - [块编码](#块编码-1)
    - [纠错](#纠错)
      - [汉明距离](#汉明距离)
      - [最小汉明距离 \[IMP\]](#最小汉明距离-imp)
    - [线性块编码](#线性块编码)
      - [简单奇偶校验](#简单奇偶校验)
      - [二维奇偶校验](#二维奇偶校验)
      - [汉明编码](#汉明编码)
    - [循环冗余校验 (CRC)](#循环冗余校验-crc)
      - [计算 \[IMP\]](#计算-imp)
        - [多项式除法](#多项式除法)
      - [差错检测能力](#差错检测能力)
        - [单个位差错](#单个位差错)
        - [两个独立的单个位差错](#两个独立的单个位差错)
        - [奇数个差错](#奇数个差错)
        - [突发性差错](#突发性差错)
        - [表现较好的生成多项式](#表现较好的生成多项式)
    - [校验和](#校验和)
  - [Chapter 11 数据链路控制](#chapter-11-数据链路控制)
    - [成帧](#成帧)
      - [面向字符协议](#面向字符协议)
      - [面向位协议](#面向位协议)
    - [流量控制与差错控制](#流量控制与差错控制)
    - [协议](#协议)
      - [无噪声通道](#无噪声通道)
      - [有噪声通道](#有噪声通道)
        - [停止等待 ARQ \[IMP\]](#停止等待-arq-imp)
        - [后退 N 帧 ARQ \[IMP\]](#后退-n-帧-arq-imp)
        - [选择性重复 ARQ \[IMP\]](#选择性重复-arq-imp)
    - [HDLC (高级数据链路控制) \[IMP\]](#hdlc-高级数据链路控制-imp)
    - [点到点协议 (PPP)](#点到点协议-ppp)
  - [Chapter 12 多路访问](#chapter-12-多路访问)
    - [随机访问](#随机访问)
      - [ALOHA](#aloha)
        - [纯 ALOHA](#纯-aloha)
        - [时隙 ALOHA](#时隙-aloha)
      - [CSMA (载波侦听多路访问) \[IMP\]](#csma-载波侦听多路访问-imp)
        - [持续方法](#持续方法)
        - [CSMA/CD (带冲突检测的 载波侦听多路访问)](#csmacd-带冲突检测的-载波侦听多路访问)
        - [CSMA/CA (带冲突避免的 载波侦听多路访问)](#csmaca-带冲突避免的-载波侦听多路访问)
          - [帧间间隔 (IFS)](#帧间间隔-ifs)
          - [竞争窗口](#竞争窗口)
          - [确认](#确认)
    - [受控访问](#受控访问)
      ...
      - [轮询](#轮询)
      - [令牌传递](#令牌传递)
  - [Chapter 13 有线局域网：以太网](#chapter-13-有线局域网以太网)
    - [IEEE 标准](#ieee-标准)
    - [标准以太网的MAC子层](#标准以太网的mac子层)
      - [帧格式 \[IMP\]](#帧格式-imp)
      - [MAC 地址 \[IMP\]](#mac-地址-imp)
      - [CSMA/CD 最短帧长 \[IMP\]](#csmacd-最短帧长-imp)
      - [编码与解码](#编码与解码)
      - [标准以太网的分类](#标准以太网的分类)
    - [桥接以太网](#桥接以太网)
    - [交换式以太网](#交换式以太网)
    ...
    - [快速以太网](#快速以太网)
    - [千兆以太网](#千兆以太网)
    - [总线型以太网的信道利用率简单分析](#总线型以太网的信道利用率简单分析)
  - [Chapter 14 无线局域网](#chapter-14-无线局域网)
    - [IEEE 802.11 \[IMP\]](#ieee-80211-imp)
    - [体系结构](#体系结构)
      - [基本服务集 (BSS)](#基本服务集-bss)
      - [扩展服务集 (ESS)](#扩展服务集-ess)
      - [站点类型](#站点类型)
    - [MAC层 \[IMP\]](#mac层-imp)
      - [分布式协调功能 (DCF)](#分布式协调功能-dcf)
      - [点协调功能 (PCF)](#点协调功能-pcf)
      - [帧格式 \[IMP\]](#帧格式-imp-1)
      - [寻址机制](#寻址机制)
      - [隐藏站点 \[IMP\]](#隐藏站点-imp)
      - [暴露站点 \[IMP\]](#暴露站点-imp)
      - [物理层 \[IMP\]](#物理层-imp)
  - [Chapter 15 连接局域网、主干网和虚拟局域网](#chapter-15-连接局域网主干网和虚拟局域网)
    - [连接设备 \[IMP\]](#连接设备-imp)
      - [无源集线器](#无源集线器)
      - [中继器](#中继器)
      - [有源集线器](#有源集线器)
      ...
      - [三层交换机](#三层交换机)
      - [网关](#网关)
    - [冲突域与广播域 \[IMP\]](#冲突域与广播域-imp)
      - [冲突域](#冲突域)
      - [广播域](#广播域)
    - [VLAN (虚拟局域网)](#vlan-虚拟局域网)
  - [Chapter 16 无线 WAN：移动电话和卫星网络](#chapter-16-无线-wan移动电话和卫星网络)
  - [Chapter 17 广域网 SONET/SDH](#chapter-17-广域网-sonetsdh)
  - [Chapter 18 虚电路网络：帧中继和 ATM](#chapter-18-虚电路网络帧中继和-atm)
    - [帧中继](#帧中继)
      - [特征 \[IMP\]](#特征-imp)
      - [永久交换虚电路 (PVC)](#永久交换虚电路-pvc)
      - [交换虚电路 (SVC)](#交换虚电路-svc)
      - [帧结构](#帧结构)
    - [ATM (异步传输模式)](#atm-异步传输模式)
      - [特征](#特征)
      - [结构 \[IMP\]](#结构-imp)
- [Part 4 网络层](#part-4-网络层)
  - [Chapter 19 逻辑寻址 \[IMP\]](#chapter-19-逻辑寻址-imp)
    - [IPv4 地址](#ipv4-地址)
      - [分类寻址](#分类寻址)
      - [无类寻址](#无类寻址)
        - [层次结构](#层次结构)
    ...
    - [IPv6 地址](#ipv6-地址)
  - [Chapter 20 IP协议](#chapter-20-ip协议)
    - [网际互连](#网际互连)
    - [IPv4](#ipv4)
      - [数据报格式 \[IMP\]](#数据报格式-imp)
      - [MTU (最大传输单元) 与分段](#mtu-最大传输单元-与分段)
    - [IPv6](#ipv6)
      - [数据报格式 \[IMP\]](#数据报格式-imp-1)
    - [IPv4 IPv6 头部对比](#ipv4-ipv6-头部对比)
    - [IPv4 IPv6 混合](#ipv4-ipv6-混合)
  - [Chapter 21 地址映射、差错报告和多播](#chapter-21-地址映射差错报告和多播)
    - [ARP](#arp)
      - [概念 \[IMP\]](#概念-imp)
      - [分组格式](#分组格式)
      - [操作](#操作)
    ...
    - [ICMP](#icmp)
      ...
      - [查询报文](#查询报文)
    - [IGMP](#igmp)
  - [Chapter 22 传递、转发和路由选择](#chapter-22-传递转发和路由选择)
    - [转发技术](#转发技术)
    - [转发过程](#转发过程)
    - [地址聚合 \[IMP\]](#地址聚合-imp)
    - [最长掩码匹配 \[IMP\]](#最长掩码匹配-imp)
- [Part 5 传输层](#part-5-传输层)
  - [Chapter 23 UDP、TCP 和 SCTP](#chapter-23-udptcp-和-sctp)
    - [端口 \[IMP\]](#端口-imp)
    - [UDP](#udp)
      - [概念](#概念)
      - [UDP 的熟知端口 \[IMP\]](#udp-的熟知端口-imp)
      - [数据报结构](#数据报结构)
      - [校验和 \[IMP\]](#校验和-imp)
    - [TCP \[IMP\]](#tcp-imp)
      - [概念与特点](#概念与特点)
      ...
      - [差错控制](#差错控制)
        ...
        - [重传](#重传)
      - [TCP 拥塞控制](#tcp-拥塞控制)
      - [TCP 流量控制 \[IMP\]](#tcp-流量控制-imp)
  - [Chapter 24 拥塞控制和服务质量](#chapter-24-拥塞控制和服务质量)
    - [吞吐量和延迟 \[IMP\]](#吞吐量和延迟-imp)
    - [拥塞控制 \[IMP\]](#拥塞控制-imp)
      - [开环拥塞控制](#开环拥塞控制)
      - [闭环拥塞控制](#闭环拥塞控制)
- [Part 6 应用层](#part-6-应用层)
  - [Chapter 25 域名系统](#chapter-25-域名系统)
    - [域名空间 \[IMP\]](#域名空间-imp)
    - [客户端服务器模式的域名解析 \[IMP\]](#客户端服务器模式的域名解析-imp)
    - [DNS 报文](#dns-报文)
  - [Chapter 26 远程登录、电子邮件和文件传输](#chapter-26-远程登录电子邮件和文件传输)
    - [TELNET](#telnet)
    - [电子邮件](#电子邮件)
      - [构架](#构架)
      - [MIME \[IMP\]](#mime-imp)
      - [SMTP \[IMP\]](#smtp-imp)
      - [POP3 和 IMAP4 \[IMP\]](#pop3-和-imap4-imp)
    - [文件传输](#文件传输)
      - [FTP \[IMP\]](#ftp-imp)
  - [Chapter 27 万维网与超文本传输协议](#chapter-27-万维网与超文本传输协议)
    - [URL \[IMP\]](#url-imp)
    - [HTTP](#http)
      - [概念 \[IMP\]](#概念-imp-2)
      - [报文结构 \[IMP\]](#报文结构-imp)
...
![Model](./CS-Network-Review-and-Summary/20210616190804.png)
...
![编码方案](./CS-Network-Review-and-Summary/20210615193504.png)
...
![NRZ-L/I](./CS-Network-Review-and-Summary/20210615193725.png)
...
![RZ](./CS-Network-Review-and-Summary/20210615194511.png)

在位中间信号必定归零, $r = \frac{1}{2}$

#### 曼彻斯特编码 和 差分曼彻斯特编码

![Manchester/DiffMan](./CS-Network-Review-and-Summary/20210615194637.png)
...
![AMI/Pseudo](./CS-Network-Review-and-Summary/20210615195837.png)
...
![Summary](./CS-Network-Review-and-Summary/20210615200432.png)
...
![AnalogTrans](./CS-Network-Review-and-Summary/20210616184347.png)
...
![ASK](./CS-Network-Review-and-Summary/20210616184439.png)
...
![FSK](./CS-Network-Review-and-Summary/20210616184518.png)
...
![BPSK](./CS-Network-Review-and-Summary/20210616185709.png)
...
- 带宽: $B=(1+d) \times S$, 和 BFSK 一样
- $L=4, \ r = 2$

#### 星座图

![Constellation](./CS-Network-Review-and-Summary/20210616190219.png)
...
![S-TDM](./CS-Network-Review-and-Summary/./CS-Network-Review-and-Summary/20210617185037.png)
...
![Stat-TDM](./CS-Network-Review-and-Summary/20210617191722.png)
...
![FHSS](./CS-Network-Review-and-Summary/20210617192640.png)
...
![DSSS](./CS-Network-Review-and-Summary/20210617193003.png)
...
![CCable](./CS-Network-Review-and-Summary/20210617210129.png)
...
![Fiber](./CS-Network-Review-and-Summary/20210617210412.png)
...
![ElecSpectrum](./CS-Network-Review-and-Summary/20210617210557.png)
...
![CircuitExchange](./CS-Network-Review-and-Summary/20210617211550.png)

![CircuitExchange](./CS-Network-Review-and-Summary/20210617211411.png)
...
![DatagramExchange](./CS-Network-Review-and-Summary/20210617212244.png)

![DatagramExchange](./CS-Network-Review-and-Summary/20210617212312.png)
...
![setup1](./CS-Network-Review-and-Summary/20210617214418.png)

1. A 向交换机 1 发送建立连接帧
2. 交换机1从端口1接受帧, 分配一个VCI, 通过路由表得到应发往端口3, 但输出VCI留空
3. 交换机2~3相同

![setup2](./CS-Network-Review-and-Summary/20210617214431.png)
...
![CRC](./CS-Network-Review-and-Summary/20210618003752.png)
...
![S-W ARQ](./CS-Network-Review-and-Summary/20210618154248.png)
...
![B-N ARQ Window](./CS-Network-Review-and-Summary/20210618154515.png)

> 发送方窗口变化

![B-N ARQ Window](./CS-Network-Review-and-Summary/20210618154554.png)

> 接收方窗口变化

![B-N ARQ](./CS-Network-Review-and-Summary/20210618154629.png)
...
![S ARQ SW](./CS-Network-Review-and-Summary/20210618155458.png)

> 发送方窗口

![S ARQ RW](./CS-Network-Review-and-Summary/20210618155523.png)

> 接收方窗口

![S ARQ](./CS-Network-Review-and-Summary/20210618155553.png)
...
![HDLC Frame](./CS-Network-Review-and-Summary/20210618160740.png)
...
![Pure ALHOA](./CS-Network-Review-and-Summary/20210619000926.png)
...
![Slot ALOHA](./CS-Network-Review-and-Summary/20210619000952.png)

- 将时间按照 $T_{fr}$ 分割为时隙, 必须在时隙开始发送帧
- 脆弱时间: $T_{fr}$
- 吞吐量: $S=G \times e^{-G}$, $G = 1$, $S_{max} = 0.368$
...
![Persistent](./CS-Network-Review-and-Summary/20210619001045.png)
...
![CSMA/CD](./CS-Network-Review-and-Summary/20210619001132.png)
...
![Methods](./CS-Network-Review-and-Summary/20210619001153.png)
...
![Frame](./CS-Network-Review-and-Summary/20210619205903.png)
...
- 发送顺序: 每个字节的低位在前, 逐字节发送
  - 例如 `47:20`, 发送顺序为 `11100010 00000100`
...
![ESS](./CS-Network-Review-and-Summary/20210619230019.png)
...
![MAC Layer](./CS-Network-Review-and-Summary/20210619230043.png)
...
![CSMA/CA Flowchart](./CS-Network-Review-and-Summary/20210619230422.png)
...
![Frame](./CS-Network-Review-and-Summary/20210619230923.png)
...
![Situations](./CS-Network-Review-and-Summary/20210619231301.png)
...
![Hidden Station](./CS-Network-Review-and-Summary/20210619231646.png)
...
![Exposed Station](./CS-Network-Review-and-Summary/20210619232117.png)
...
![TP VP VC](./CS-Network-Review-and-Summary/20210620160805.png)

![TP VP VC](./CS-Network-Review-and-Summary/20210620160831.png)
...
![Class](./CS-Network-Review-and-Summary/20210621005156.png)
...
![ipv4](./CS-Network-Review-and-Summary/20210621151131.png)

![ipv4](./CS-Network-Review-and-Summary/20210621150443.png)
...
![ipv6](./CS-Network-Review-and-Summary/20210621195449.png)
...
![arp](./CS-Network-Review-and-Summary/20210621205627.png)
...
![aggregate](./CS-Network-Review-and-Summary/20210622000936.png)
...
![longest match](./CS-Network-Review-and-Summary/20210622001259.png)
...
![udp port](./CS-Network-Review-and-Summary/20210622002944.png)

> 可以看书 p468

#### 数据报结构

![header](./CS-Network-Review-and-Summary/20210622003102.png)
...
![p header](./CS-Network-Review-and-Summary/20210622003643.png)
...
![tcp segment](./CS-Network-Review-and-Summary/20210622004618.png)
...
![tcp establish](./CS-Network-Review-and-Summary/20210622104459.png)
...
![3 wave](./CS-Network-Review-and-Summary/20210622105351.png)
...
![4 wave](./CS-Network-Review-and-Summary/20210622105644.png)
...
![RTO](./CS-Network-Review-and-Summary/20210622111546.png)
> 重传计时器超时重传

![3 ACK](./CS-Network-Review-and-Summary/20210622111612.png)
...
![c-control](./CS-Network-Review-and-Summary/20210622114245.png)
...
![Window](./CS-Network-Review-and-Summary/20210622124037.png)
...
![req](./CS-Network-Review-and-Summary/20210622141444.png)
> 请求报文的结构

![res](./CS-Network-Review-and-Summary/20210622141525.png)
> 响应报文的结构
